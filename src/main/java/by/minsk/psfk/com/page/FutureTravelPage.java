...
public class FutureTravelPage extends Page{

	private static final Logger LOGGER = Logger.getLogger(FutureTravelPage.class);

	@FindBy(xpath = "//button[@id = 'btnFullScreen']")
	private WebElement buttonFullSize;

	private final By xpathLocatorToPlayer = 
			By.xpath("//iframe[@src = 'https://www.slideshare.net/slideshow/embed_code/55182148']");

	
	public FutureTravelPage(WebDriver driver) {
		super(driver);
	}
