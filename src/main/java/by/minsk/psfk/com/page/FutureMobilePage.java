...
public class FutureMobilePage extends Page {
	...
	private final By xpathLocatorToPlayer = 
			By.xpath("//iframe[@src = 'http://www.slideshare.net/slideshow/embed_code/6508371']");

	public FutureMobilePage(WebDriver driver) {
		super(driver);
	}
